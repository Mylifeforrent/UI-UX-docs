...
5. 阅读 [Figma 体系](docs/05-ai-design-workflow/figma-stack.md)。需求不确定走**路径 A**：[原型先行全流程实操](docs/05-ai-design-workflow/prototype-first-workflow.md)。PRD 已完备、要用 Make 做高保真并落地代码走**路径 B**：[Figma Make 高保真保姆级教程](docs/05-ai-design-workflow/figma-make-high-fidelity.md) 与 [PRD 到原型](docs/06-engineering-workflow/prd-to-prototype.md)。两条路径都进入 [原型到代码](docs/06-engineering-workflow/prototype-to-code.md)。
